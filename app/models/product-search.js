...
export default DS.Model.extend({
  	image 	: DS.attr('image-standard'),	//	Image	 	The first image of the product hit for the configured viewtype.
	...
	variation_attributes : DS.attr('variation-attributes'),	 // [VariationAttribute]	 	Array of represented variation attributes. Can be empty. For master product only.
